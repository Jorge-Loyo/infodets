...
start "Backend" cmd /k "cd /d %~dp0Backend && venv\Scripts\pip.exe install -r requirements.txt >nul 2>&1 && venv\Scripts\uvicorn.exe main:app --reload --host 0.0.0.0 --port 8000"
