...
SECCIONES_FRONTEND = ['consulta', 'mis_consultas', 'perfil', 'documentacion', 'noticias', 'configuracion', 'configuracion_chat', 'dashboard']
...
PERMISOS_OPERADOR = {
    'consulta': True, 'mis_consultas': True, 'perfil': True, 'documentacion': True,
...
PERMISOS_VISOR.update({'consulta': True, 'mis_consultas': True, 'perfil': True})
