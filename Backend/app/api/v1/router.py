...
from app.api.v1.routes.ingesta_routes import router as ingesta_router, public_router as ingesta_public_router
...
api_router.include_router(ingesta_public_router)
